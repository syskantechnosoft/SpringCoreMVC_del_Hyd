...
import com.happy.service.EmployeeService;
...
public class EmployeeController {
	...
	public ModelAndView saveEmployee(@ModelAttribute("command") Employee employeeBean, BindingResult result) {
	...
	public ModelAndView addEmployee(@ModelAttribute("command") Employee employeeBean, BindingResult result) {
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("employees", prepareListofBean(employeeService.listEmployees()));
	...
	public ModelAndView editEmployee(@ModelAttribute("command") Employee employeeBean, BindingResult result) {
	...
	public ModelAndView deleteEmployee(@ModelAttribute("command") Employee employeeBean, BindingResult result) {
		Map<String, Object> model = new HashMap<String, Object>();
